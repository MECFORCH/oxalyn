...
module oxalyn_uart #(
    ...
    output wire        irq_rx,          // RX buffer dolu seviye kesmesi
    output wire        irq_tx,          // TX yeni byte kabul edebilir kesmesi
    // FPGA pinleri
    output wire        uart_tx,
    input  wire        uart_rx
);
    ...
    // Kesme kaynakları seviye tetiklemelidir: RX, CPU 0xFF'i okuyana kadar;
    // TX ise verici yeni byte kabul edene kadar etkin kalır.
    assign irq_rx = rx_buf_valid;
    assign irq_tx = tx_ready;
