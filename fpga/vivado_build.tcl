# ============================================================
# Oxalyn-64 CPU — Vivado Build Scripti
#
...
set top_dir [file join $src_dir ..]   ;# Oxalyn kaynak kökü

# Verilog kaynakları
add_files -norecurse [list \
    [file join $src_dir oxalyn_top.v]   \
    [file join $src_dir oxalyn_bram.v]  \
    [file join $src_dir uart.v]         \
    [file join $src_dir seg7_ctrl.v]    \
    [file join $top_dir cpu.v]          \
    [file join $top_dir gravityon fpga gpu_core.v] \
]
