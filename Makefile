...
.PHONY: all build simulator compiler cc bin2mem tools voxel-demo test test-kernel compiler-test bin2mem-test gpu-kernel-test sim-verilog synth-check formal gravityon clean help kernel kernel-oxalyn kernel-oxalyn-objects kernel-oxalyn-wasm kernel-oxalyn-link-test
